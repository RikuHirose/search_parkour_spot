(function() {
  ...
  $('#like_store').on('click', function() {
    ...
    var contentuserid = $('#content_user_id').val();

    storelike(contentid, userid, contentuserid);
  });
  ...
  function storelike(contentid,userid, contentuserid) {
      var _token = $('meta[name="csrf-token"]').attr('content');

      $.post('/api/content/{content}/likes', {contentid: contentid, userid: userid,contentuserid: contentuserid,  _token: _token}, function (match) {
